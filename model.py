...
def get_medical_model():
    ...
    disease_prior = [[0.02], [0.04], [0.12], [0.10], [0.01], [0.015], [0.03], [0.05], 
                    [0.01], [0.01], [0.005], [0.03], [0.015], [0.02], [0.525]]
    ...
    symptom_probs = {
        ...
        # Respiratory
        "Cough":            [0.80, 0.85, 0.65, 0.10, 0.90, 0.85, 0.15, 0.25, 0.25, 1.00, 0.95, 0.05, 0.01, 0.02, 0.01],
        "ShortnessOfBreath":[0.60, 0.25, 0.02, 0.01, 0.85, 0.30, 0.01, 0.01, 0.05, 0.60, 0.70, 0.01, 0.001, 0.001, 0.001],
        ...
        "Wheezing":         [0.10, 0.20, 0.05, 0.25, 0.45, 0.65, 0.05, 0.05, 0.05, 0.98, 0.35, 0.01, 0.01, 0.02, 0.005],
        ...
        # Digestive
        "Nausea":           [0.30, 0.15, 0.05, 0.01, 0.25, 0.05, 0.15, 0.05, 0.25, 0.05, 0.25, 0.95, 0.85, 0.15, 0.005],
        "Vomiting":         [0.15, 0.10, 0.02, 0.01, 0.15, 0.02, 0.05, 0.02, 0.05, 0.02, 0.15, 0.90, 0.65, 0.10, 0.001],
        "Diarrhea":         [0.20, 0.10, 0.02, 0.01, 0.05, 0.02, 0.02, 0.01, 0.05, 0.01, 0.05, 0.85, 0.01, 0.02, 0.001],
        
        # Neuro/Sensory
        "Headache":         [0.55, 0.65, 0.35, 0.25, 0.45, 0.25, 0.25, 0.85, 0.65, 0.25, 0.45, 0.25, 1.00, 0.35, 0.02],
        "Dizziness":        [0.25, 0.20, 0.05, 0.05, 0.25, 0.15, 0.05, 0.15, 0.35, 0.15, 0.25, 0.35, 0.95, 0.45, 0.005],
